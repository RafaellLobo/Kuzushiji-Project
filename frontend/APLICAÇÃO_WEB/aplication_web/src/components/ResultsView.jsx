    ...
    <div className="w-full max-w-full animate-fade-in">
      <div className="flex flex-col md:flex-row gap-3 sm:gap-6 md:gap-8">
        <div className="md:w-1/2 flex flex-col items-center">
          <div className="w-full max-w-full border-2 border-border rounded-xl sm:rounded-none p-2 bg-background/50 shadow-md overflow-hidden">
            <img
              src={previewUrl}
              alt="Uploaded kuzushiji text"
              className="w-full max-w-full h-auto max-h-[38dvh] sm:max-h-96 object-contain rounded-xl sm:rounded-none"
            />
          </div>
        ...
        <div className="md:w-1/2 flex flex-col">
          ...
          <div className="flex-1 w-full max-w-full bg-background/60 border border-border rounded-xl sm:rounded-none p-3 sm:p-5 mb-3 sm:mb-5 min-h-[132px] sm:min-h-[200px] shadow-inner flex flex-col justify-center overflow-hidden">
            {hasError && (
            ...
            {(state === "results_jp" || state === "results_en") && translationData && (
              <div className="space-y-3 sm:space-y-4 animate-fade-in w-full">
                <div>
                  ...
                  <p className="font-display text-base sm:text-lg tracking-widest text-foreground break-words whitespace-pre-wrap">
                ...
                <div className="pt-2 border-t border-border/50">
                  ...
                  <p className="font-display text-foreground leading-relaxed break-words whitespace-pre-wrap">
                ...
                {state === "results_en" && (
                  <div className="pt-2 border-t border-border/50 animate-fade-in">
                    ...
                    <p className="font-display text-foreground leading-relaxed italic break-words whitespace-pre-wrap">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            {state === "preview" ? (
              <button
                ...
                className="w-full min-h-12 flex items-center justify-center gap-2 px-5 py-3 bg-deepCrimson text-white font-display text-sm rounded-xl sm:rounded-none hover:bg-deepCrimson/90 transition-all shadow-md"
              >
              ...
              <button
                ...
                className={`w-full min-h-12 flex items-center justify-center gap-2 px-5 py-3 font-display text-sm rounded-xl sm:rounded-none transition-all shadow-md
                  ${state === "results_en"
      ...
      <div className="flex justify-center mt-4 sm:mt-8 pt-3 sm:pt-5 border-t border-border/50">
        <button
          onClick={onReset}
          className="w-full sm:w-auto min-h-11 flex items-center justify-center gap-2 px-5 py-2 text-muted-foreground hover:text-foreground font-display text-sm transition-colors duration-300"
        >
